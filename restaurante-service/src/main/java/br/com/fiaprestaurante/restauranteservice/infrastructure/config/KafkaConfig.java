...
/**
 * Configuracao explicita do Kafka — producer, consumer e listener container.
 *
 * <p>Espelha o {@code KafkaConfig} do {@code restaurante-pedido} (Boot 4 nao
 * traz autoconfigure de Kafka; beans precisam ser declarados manualmente).
 *
